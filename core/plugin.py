...
original. `core/backbone.py` names the seam; this file does the wiring.
...
from core.backbone import Embeddings, SeqBatch
...
def register_plugged(
    ...
    _Plugged.__doc__ = (
        ...
        f"seam. Generated by core/plugin.py:register_plugged."
    )
    if spec is not None:
