...
def read_data_from_csv(read_file, write_file):
    ...
    user_inters = []
    for user, tmp_inter in df.groupby('user_id', sort=False):
        # 保险：防止 groupby 返回一元 tuple
        ...
        user_inters.append([[str(user), str(seq_len)], seq_problems, seq_skills, seq_ans, seq_start_time, seq_response_cost])
