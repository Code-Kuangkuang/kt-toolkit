"""CsKT port for KT-Toolkit.

    csKT: Addressing Cold-start Problem in Knowledge Tracing via Kernel Bias
    and Cone Attention, Expert Systems with Applications 2025.

Source: pykt-team/pykt-toolkit, pykt/models/cskt.py (fetched 2026-09-18).
...
class CsKT(CSKT):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for key in ('device', 'dpath', 'num_at', 'num_it', 'seed', 'final_fc_dim2'):
            kwargs.pop(key, None)
        if emb_size is None:
